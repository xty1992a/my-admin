      ...
      <div class="table-container" v-loading="loading.user">
        <el-table :data="userList">
          ...
          <el-table-column label="操作">
            <template slot-scope="scope">
              <router-link :to="`/Home/UserEdit?user=${scope.row.token}`">
                <el-button type="primary">编辑</el-button>
              </router-link>
              <el-button type="danger" @click="delUser(scope.row.key)" :disabled="scope.row.token==='admin'">删除</el-button>
            </template>
          </el-table-column>
        </el-table>
        ...
        <el-table :data="editorList">
          ...
          <el-table-column label="操作">
            <template slot-scope="scope">
              ...
              <el-button type="danger" @click="delEditor(scope.row.key)" :disabled="scope.row.key==='admin'">删除</el-button>
            </template>
          </el-table-column>
        </el-table>
