...
export const deleteRole = (key) => request({data: {params: {key}}, url: '/api/User/DeleteEditor'})
export const editRole = (data) => request({data, url: '/api/User/RewriteEditor'})
export const getRoleList = () => request({data: {}, url: '/api/User/getEditorList', method: 'GET'}, false)
